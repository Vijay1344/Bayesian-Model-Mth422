...
plot(MCMC.out$sigmaSq.chain[,2],xlab = "Iteration", ylab = "sigmaSq2", type = "l")
plot(MCMC.out$sigmaSq.chain[,3],xlab = "Iteration", ylab = "sigmaSq3", type = "l")
plot(MCMC.out$sigmaSq.chain[,4],xlab = "Iteration", ylab = "sigmaSq4", type = "l")
plot(MCMC.out$sigmaSq.chain[,5],xlab = "Iteration", ylab = "sigmaSq5", type = "l")
plot(MCMC.out$sigmaSq.chain[,6],xlab = "Iteration", ylab = "sigmaSq6", type = "l")
plot(MCMC.out$sigmaSq.chain[,7],xlab = "Iteration", ylab = "sigmaSq7", type = "l")
plot(MCMC.out$sigmaSq.chain[,8],xlab = "Iteration", ylab = "sigmaSq8", type = "l")
plot(MCMC.out$sigmaSq.chain[,9],xlab = "Iteration", ylab = "sigmaSq9", type = "l")
plot(MCMC.out$sigmaSq.chain[,10],xlab = "Iteration", ylab = "sigmaSq10", type = "l")
...
tau_init <- rep(0.0001, n)
inits <- list(tau = tau_init, b = 0.004)
model <- jags.model(model_string, data = data, inits = inits, quiet = TRUE)
update(model, 10000, progress.bar = "none")
params <- c("b", "sigma.sq")
samples <- coda.samples(model,
